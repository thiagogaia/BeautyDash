    ...
    teams: [
      {
        label: "Zéca Urubu",
        value: "zeca urubu",
        image: "https://i.imgur.com/Q1OgylT.png",
      },
    ],
  },
  {
    ...
    teams: [
      {
        label: "Pica pau LTDA.",
        value: "pica pau",
        image: "https://i.imgur.com/cddXmiK.png",
      },
      {
        label: "Leôncio Inc.",
        value: "leoncio",
        image: "https://i.imgur.com/JOJ7VY2.jpg",
      },
    ],
  },
];
        ...
        <PopoverTrigger asChild>
          ...
          >
            <Avatar className="mr-2 h-5 w-5">
              <AvatarImage src={selectedTeam.image} alt={selectedTeam.label} />
              ...
              {groups.map((group) => (
                <CommandGroup key={group.label} heading={group.label}>
                  {group.teams.map((team) => (
                    ...
                    >
                      <Avatar className="mr-2 h-5 w-5">
                        <AvatarImage src={team.image} alt={team.label} />
                        <AvatarFallback>SC</AvatarFallback>
                      </Avatar>
                      {team.label}
                      <CheckIcon
