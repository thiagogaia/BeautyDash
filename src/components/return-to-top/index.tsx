      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span
            ...
            className="bg-blue-500 text-white rounded-full p-3 fixed z-50 bottom-16 right-16 shadow-[0px_1px_5px_hsl(var(--primary))] cursor-pointer opacity-0 pointer-events-none transition-opacity duration-500"
          >
